...
jQuery(document).ready(function() {		
	...
	var logo_dir_1				='images/cis3auxlogowsmaller.png'; // change with your logo path
	...
	var logo_left_top_margin	= '100px'; // define margin top for 'left' logo image
...
function h_center_logo(){
	...
	jQuery('.header_center ul#mainmenu > li').each(function() {
		if(i == Math.floor(position/2)-1) {
			jQuery(this).after('<a href = "index.html"><li class="logo_pos"><img class="c_logo_light" src="'+logo_dir_1+'"/></a><img class="c_logo_dark" src="'+logo_dir_2+'"/></li>');
	}
	i++;
	});
	// settings
